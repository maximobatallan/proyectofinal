...
with open('category_classifier1.pkl', 'rb') as f:
    clf = pickle.load(f)

#vectorizer = joblib.load('vectorizar.sav')

with open('category_vectorizer1.pkl', 'rb') as f:
...
if submit:
    ...
    df = pd.read_csv(f'products/{prediccion}.csv')
    df1 =df['imUrl'].head(8)
    j = 0
